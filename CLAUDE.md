...
**Ivan Robayo** — Colombian mentor de trabajo remoto, entrepreneur, writer, and content creator. His own identity ordering for the brand is **"Mentor de Trabajo Remoto, Empresario y Escritor"** — keep that order in any identity description. Known online as **@ivan.remoto** (Instagram) and **@soyivanrobayo** (YouTube). He has worked remotely for 8+ years for US/European companies and is an **expert in remote career building**. Two products: **El Protocolo Remoto** (Skool, low-ticket) and a premium 90-day 1:1 mentorship. ⚠️ **The "Oasis" brand is DEAD (removed 2026-07-12)** — never reintroduce it. Brand = **Ivan Remoto**; the Skool community/product = **El Protocolo Remoto**.
...
1. **ivanro.com/** (index) — the LOW-TICKET OFFER landing: "Sé dueño de tu tiempo" / low effort high return. Sells **El Protocolo Remoto** on Skool for **$27 USD (antes $500 — honest anchor, real prior price)**. EXACTLY TWO routes (💼 empleo remoto high-income + ⚙️ operador de marca — "cómo construyo este negocio mientras juego videojuegos 🎮"); everything else is the BONUS STACK on top (notas + IA / segundo cerebro, calendario, productividad, todos sus libros, estrategia de redes, concursos para ganar una mentoría 1:1) — never present the bonus as a third route. Primary CTA everywhere: the Skool link. Includes Ivan's burn-out story (empresas desde los 24 → burnout → low effort high return), a LIGHT bridge to the premium mentorship (do not push the high ticket hard), and a "¿Todavía no me crees?" section funneling non-buyers to YouTube/Instagram/Substack to marinate in free content. Tone: confident, never apologetic.
